...
Hloubka a odůvodnění: [INDEX.md](INDEX.md).

Stejný obsah je v rootu repa jako path-scoped pravidlo pro Claude Code:
[rules/frontend-ux.md](../../../../rules/frontend-ux.md).
...
Zdroj: [UX Laws](zakony-principy/ux-laws.md).
...
Zdroj: [Osmibodová mřížka](zakony-principy/osmibodova-mrizka.md), [Layout Theory](layout/layout-theory.md).
...
Zdroj: [Pravidlo 60-30-10](color/pravidlo-60-30-10.md), [Color Theory](color/color-theory.md).
...
Zdroj: [Typography — základy, anatomie](typography/typography-zaklady-anatomie.md).
...
Zdroj: [GENERAL UX KNOWLEDGE](ux-zaklady/general-ux-knowledge.md).
...
- Než stavím: kdo je uživatel, jaký je jeho cíl, jaký je hlavní flow.
  Postup: [Step By Step UX-UI](proces/step-by-step-ux-ui.md).
