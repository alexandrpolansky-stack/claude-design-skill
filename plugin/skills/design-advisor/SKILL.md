...
## Zdroj znalosti
[references/INDEX.md](references/INDEX.md) — mapa celé znalostní báze. Otevři index, vyber relevantní sekce a přečti je. Nečti celý index dokola; vezmi jen to, co k úkolu patří, a odkaž na konkrétní notu.
...
4. **U větší stavby** projdi proces (uživatel → cíl → flow → wireframe): [references/proces/step-by-step-ux-ui.md](references/proces/step-by-step-ux-ui.md).
5. **Hotový příklad** design systému s konkrétními tokeny: [references/priklady-ds/design-system-drive.md](references/priklady-ds/design-system-drive.md).
6. **Když píšeš UI kód**, drž se destilátu [references/frontend-ux-rules.md](references/frontend-ux-rules.md).
...
- Hloubka je vždy v `references/`, v SKILL.md i v pravidle je jen destilát.
