...
Box model, selektory, struktura dokumentu. Úvodní materiál, ne referenční příručka.

Související: [Vkládání CSS](inserting-css.md) · [Stylizace textu](stylizace-textu.md) · [Volba obrázků](using-best-images.md)

> [!warning] Rozsah téhle noty
> Je to **úvodní materiál z původního importu**, ne referenční příručka. Obsahuje značky, třídy,
> ID, barvy, fonty a strukturu dokumentu. **Nejsou tu: CSS grid, flexbox, `box-shadow`, formulářové
> vzory, media queries.** Tři noty na tuhle notu dřív odkazovaly kvůli gridu, stínu a formulářům,
> což tady nikdy nebylo; opraveno 23. 8. 2026.
>
> Notu doprovázelo **šestnáct screenshotů kódu a výsledků**, které v repu nejsou. Text byl psaný
> jako komentář k nim, takže místy vysvětluje míň, než vypadá. Odkazy na chybějící obrázky byly
> odstraněny 23. 8. 2026 i s titulky, které bez nich nic neznamenaly.
>
> Implementační znalost, kterou knihovna opravdu má, je v
> [enterprise-ui/vzory/](../enterprise-ui/vzory/): zkracování a `min-width: 0`, stacking context
> a překryvy, stabilita layoutu. Ta je třída A ze specifikace.
...
Stále platí, **že vzhled prodává** bez **HTML a CSS by byly weby nepřehledné bez základních grafických úprav**, což je rozdíl mezi holým textem a stránkou se strukturou a stylem. H a C nám dává hned několik bodů proč ho používat
- **Lehčí na čtení**
