...
Stát se dobrým UX designerem vyžaduje **mluvit s uživateli** = dělat research
	**Vy nejste uživatel** - při navrhování je důležité si uvědomit, že vy nejste uživatel. Uživatelé mohou mít různé **motivace**, **zájmy**, **dovednosti** atd. to vše je potřeba vzít v úvahu
	...
	Je důležité pochopit a objasnit, kdo jsou uživatelé, jaké jsou jeho problémy, eliminovali nesprávné předpoklady a sladili členy týmu.
Pět W+H (WHO, WHAT, WHY, WHERE, WHEN a HOW)
	**Kdo jsou uživatelé** - demografický, kulturní vliv?, vzdělání, profesní situace
	**Jaké jsou jejich zvyky** - Používají sociální sítě?, vztah k technologiím?, Rychlé nebo pomalé osvojení produktu?
	**Kde získávají informace** - doma? v práci? na cestách? 
	**Kdy kontrolují** - často?, občas?, pravidelně? kde? v jakou denní dobu?
	**Proč kontrolují** - závislost?, speciální událost? Nouzová situace?
...
**User Stories**
	...
	Několik příkladů, jak můžou **User Stories** vypadat
		Kdo je uživatel pro kterého designuji
		Jaký problém je třeba vyřešit/jak se chovat
		Jaký pocit nebo přesvědčení je s ním spojeno
		Jaký je kontext
	Při psaní těchto otázek, je důležité být konkrétní
	Můžeme se řídit podle **Normanovi formule**
		"Jako [typ uživatele] chci [cíl], takže [přínos]."
		Například: Jako [majitel běžného účtu] chci [vkládat šeky pomocí mého telefonu], takže [nebudu muset chodit do banky]
		 Jako [student] chci [mít přístup k online knihovně], aby [mohu studovat z domova a nemusel chodit do fakultní knihovny].
