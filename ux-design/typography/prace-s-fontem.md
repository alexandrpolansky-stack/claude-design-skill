# Práce s fontem: řezy, spacing, zarovnání

Co dělá bold, light a regular s tónem, jak spacing a zarovnání mění dojem, a typografická hierarchie.

Související: [Typografie](../pravidla/typografie.md) · [Font pairing](font-pairing.md) · [Serif a Sans Serif](serif-a-sans-serif.md)

Kvalitní a vhodné typefacy pro práci mají různé styly a weights
...
> Původní znění dávalo podlahu **8 px**. To je hluboko pod čímkoli čitelným a jde to proti
> [Typografie](../pravidla/typografie.md) i [Senioři](../kontext/seniori.md), kde je 16 px braných
...
Spacing může určit tón projektu
	Wide nebo tight spacing
		**Wide** může vypadat, že projekt je více elegantní a high end, ale při delších frázích působí velmi obtížné (overwhelming)
			Wider spacing v lowercasu téměř **NIKDY NEFUNGUJE** = vypadá to hrozně
		**Tight** může nad ruhou stranu, vypadat více urgentně; a pomáha fráze, text udělat více propojený a soudržný

### Zarovnání
**Zarovnání na levo**
	při delším textu je vhodné použít, udělá to text více stabilní a dává jistý pocit uzemění textu
**Zarovnání na střed**
	Při krátkém textu, a krátkých slovech vypadá dobře; jasně předává zprávu a je to pro oko příjemné
**Zarovnání na pravo**
	Používá se velmi zřídka a většinou nepůsobí esteticky. Funguje tam, kde ho vyvažuje protiváha na druhé straně, typicky obrázek vlevo a text zarovnaný vpravo.
